...
import {mockHoursLesson} from "../mock";

const LessonsComponent = () => {


    const time = ["test", "test1", "test2", "test3", "tes4", "test5", "tes6", "tes7", "test8", "test9", "test10", "test11", "tes12", "tes13", "tes14", "test15"]
            ...
            <Box>
                <Flex bg={bakgroundGlobal}>
                    <Box w={"9vw"} mr="1vw" bg={bakgroundMenu}>
                        {/* @ts-ignore */}
                        <Text h="5vh" fontSize={"2rem"} display={"flex"} flexDirection="column" alignItems={"center"}
                        ...
                        <Box display={"flex"} flexDirection="column">
                            <Box h="95vh" bg="blur">
                                {
                                    mockHoursLesson.map((test) => <Box display={"flex"} flexDirection="column"
                                                            alignItems={"center"} justifyContent={"center"} mt="1"
                                                            h="5vh" bg={bakgroundList}>{test.hours}</Box>)
                                }
                            </Box>
                        </Box>
                    </Box>
                    ...
                    <Box textAlign={"center"} w='90vw' h='5vh' bg={bakgroundMenu}>
                        ...
                        <Box display={"flex"}>
                            ...
                            <Box bg={bakgroundLessonList} ml="2" mt="1" w="5" h="94vh" display={"flex"}
